...
Open pinning gaps from N1 (plus the B1/B2 realtime bodies) are batched into case S1-25 (§9) — **recorded 2026-09-15** (37/37 requests, 76 files). S1-25 recording reconciliations applied to this section:
