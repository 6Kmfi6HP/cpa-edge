# S6-03-config-yaml-roundtrip — response 5/5 (step 5)
...
## Body (exact bytes received, 1888 bytes)
```
...
remote-management:
  allow-remote: true
  secret-key: "$2a$10$jp2soczL86kX4Gz7Ad8fkOFkAI8ygTR4fLnjweg5KM.8uo1TY/FNy"
