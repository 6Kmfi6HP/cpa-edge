# s2d3-res-stopreasons-usage — response 3/3 (step 3)
...
X-Cpa-Trace-Id: 20260916015659-42f16b36d73439c3-222012d1
Date: Tue, 15 Sep 2026 17:56:59 GMT
Connection: close
Transfer-Encoding: chunked

## Body (Transfer-Encoding: chunked framing preserved) (exact bytes received, 1006 bytes)
```
...
data: {"id":"msg_stop_01","object":"chat.completion.chunk","created":1789495019,"model":"claude-mock-model","choices":[{"index":0,"delta":{},"finish_reason":"stop"}],"usage":{"prompt_tokens":137,"completion_tokens":7,"total_tokens":144,"prompt_tokens_details":{"cached_tokens":32,"cached_creation_tokens":5,"cache_write_tokens":5}}}
