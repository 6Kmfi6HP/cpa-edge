 ...
 * sets the route gates consult (S1 §3.2, §6.2).
 *
...
/**
 * Fixed image-only model ids (recorded upstream list). Any of these on a
 * non-images route is the 503 `only supported on /v1/images/*` case;
