/**
 * Trace-id family (S1 section 2): the runtime owns trace emission;
 * translator facades never do. A facade-set `X-Cpa-Trace-Id` value is
 * replaced so the format stays gateway-controlled.
 */
